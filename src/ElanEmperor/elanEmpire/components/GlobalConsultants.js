  ...
  return (
    <section className="global-consultants">
      <div className="consultant-heading">
        <h2 style={{color:'#b08968'}}>GLOBAL CONSULTANTS</h2>
        <p>
        ...
        <div className="carousel-track">
          {getVisibleCards().map((consultant, idx) => (
            <div className="consultant-card" key={idx}>
              ...
              <p className="consultant_designation">{consultant.designation}</p>
              <p className="consultant_location">{consultant.location}</p>
            </div>
          ))}
        </div>
