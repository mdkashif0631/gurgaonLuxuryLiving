  ...
  return (
    <section className='resort_container'>
        ...
        <div className='elanresortimg'>
            <img
            src='https://res.cloudinary.com/daa1hgr9j/image/upload/v1755170075/lqqho1cntugyahfioi0k.png'
            alt='resortImage'
            />
        </div>
    </section>
