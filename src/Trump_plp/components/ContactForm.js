...
export default function ContactForm() {
  ...
  useEffect(() => {
    ...
    const currentRef = sectionRef.current; // fix warning
  ...
  useEffect(() => {
    ...
    if (inView) {
      ...
      // Reset to 0 when out of view (so it replays every time)
  ...
  return (
    <section className="trum-container" id="enquire" ref={sectionRef}>
      ...
      <div className="trum-form-section">
        ...
        <div className="trum_video_box">
          <video autoPlay muted loop playsInline className="trump_video">
            <source
              src="https://res.cloudinary.com/dif213nbi/video/upload/v1754908374/Trump_video_jqndud.mp4"
              type="video/mp4"
            />
